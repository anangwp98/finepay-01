              ...
              <div class="col-lg-4">
                <div class="card card-lift--hover shadow border-0">
                  <div class="card-body py-5">
                    ...
                    <h6 class="text-primary text-uppercase">Pembayaran Tagihan</h6>
                    <p class="description mt-3">Kami siap membantu manajemen pembayaran tagihan anda di beberapa layanan penyedia cicilan dengan bunga ringan.</p>
                    <!-- <div>
                    ...
                    <a href="#" class="btn btn-primary mt-4">Pelajari Lebih Banyak</a>
                  </div>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="card card-lift--hover shadow border-0">
                  <div class="card-body py-5">
                    ...
                    <h6 class="text-success text-uppercase">Pengajuan Ciciclan</h6>
                    <p class="description mt-3">Selain kami juga membantu pembayaran, kami juga melayani pengajuan cicilan barang yang sudah kami sediakan.</p>
                    <!-- <div>
                      <span class="badge badge-pill badge-success">business</span>
                      <span class="badge badge-pill badge-success">vision</span>
                      <span class="badge badge-pill badge-success">success</span>
                    </div> -->
                    <a href="#" class="btn btn-success mt-4">Pelajari Lebih Banyak</a>
                  </div>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="card card-lift--hover shadow border-0">
                  <div class="card-body py-5">
                    ...
                    <h6 class="text-warning text-uppercase">Fine Jobs</h6>
                    <p class="description mt-3">Yang paling terpenting kami juga menyediakan solusi pembiaayaan buat user kami dengan adanya Fine Jobs.</p>
                    <!-- <div>
                    ...
                    <a href="#" class="btn btn-warning mt-4">Pelajari Lebih Banyak</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row row-grid align-items-center">
          <div class="col-md-6">
            <div class="card bg-default shadow border-0">
              <img src="./assets/img/theme/gadgets.jpeg" class="card-img-top" alt="image">
              <blockquote class="card-blockquote">
                <svg preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 583 95" class="svg-bg">
                  <polygon points="0,52 583,95 0,95" class="fill-default" />
                  <polygon points="0,42 583,95 683,0 0,95" opacity=".2" class="fill-default" />
                </svg>
                <h4 class="display-3 font-weight-bold text-white">Dapatkan Barang yang kamu butuhkan Disini</h4>
          ...
          <div class="col-md-6">
            <div class="pl-md-5">
              ...
              <h3>Ketentuan Pembelian</h3>
              <p class="lead">Barang tidak boleh berunsur senjata tajam dan obat terlarang</p>
              <p>Tidak boleh melakukan Pembelian untuk orang lain</p>
              <p>Jika barang yang diterima tidak sesuai dengan pembelian, dapat dilakukan pengembalian</p>
        ...
        <div class="row row-grid align-items-center">
          ...
          <div class="col-lg-6 order-lg-1">
            <div class="d-flex px-3">
              ...
              <div class="pl-4">
                <h4 class="display-3 text-white">Teknologi Yang Kami Gunakan</h4>
                <p class="text-white">Kami memperhatikan teknologi yang sangat canggih saat ini, sehingga kami sangat peduli tentang teknologi yang kami gunkana di perusahaan kami sehingga anda bisa melakukan aktifitas tanpa masalah.</p>
              </div>
            </div>
            <div class="card shadow shadow-lg--hover mt-5">
              <div class="card-body">
                <div class="d-flex px-3">
                  ...
                  <div class="pl-4">
                    <h5 class="title text-success">Virtual Verification</h5>
                    <p>Memungkinkan anda hanya duduk manis di depan gadget anda, maka kami akan verifikasi data diri anda dengan baik.</p>
                    <a href="#" class="text-success">Pelajari Lebih Banyak</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="d-flex px-3">
                  ...
                  <div class="pl-4">
                    ...
                    <a href="#" class="text-warning">Pelajari Lebih Banyak</a>
                  </div>
                </div>
              </div>
            </div> -->
    ...
    <section class="section section-lg">
      <div class="container">
        <div class="row justify-content-center text-center mb-lg">
          <div class="col-lg-8">
            <h2 class="display-3">Team Kami</h2>
            <p class="lead text-muted">Kami Akan Selalu Mencari Solusi untuk Masalah Finansial Anda</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
            <div class="px-4">
              <img src="./assets/img/theme/anang.png" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;" alt="image">
              <div class="pt-4 text-center">
                <h5 class="title">
                  <span class="d-block mb-1">Anang Wahyu Pradana</span>
                  <small class="h6 text-muted">Chief Executive Officer</small>
                </h5>
                <div class="mt-3">
          ...
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
            <div class="px-4">
              <img src="./assets/img/theme/rona.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;" alt="image">
              <div class="pt-4 text-center">
                <h5 class="title">
                  <span class="d-block mb-1">M Rona Setyowardani</span>
                  <small class="h6 text-muted">Chairman of the Board of Directors</small>
                </h5>
                <div class="mt-3">
          ...
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
            <div class="px-4">
              <img alt="image" src="./assets/img/theme/nisa.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
              <div class="pt-4 text-center">
                <h5 class="title">
                  <span class="d-block mb-1">Nur Anisah</span>
                  <small class="h6 text-muted">Chief Operating Officer</small>
                </h5>
                <div class="mt-3">
          ...
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
            <div class="px-4">
              <img alt="image" src="./assets/img/theme/rizki.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
              <div class="pt-4 text-center">
                <h5 class="title">
                  <span class="d-block mb-1">Rizki Hanggoro</span>
                  <small class="h6 text-muted">President Director</small>
                </h5>
                <div class="mt-3">
    ...
    <section class="section section-lg bg-gradient-default">
      <div class="container pt-lg pb-300">
        <div class="row text-center justify-content-center">
          <div class="col-lg-10">
            <h2 class="display-3 text-white">Layanan Kami </h2>
            <!-- <p class="lead text-white">Layanan kami sudah terdaftar di Otoritas Jasa Keuangan</p> -->
          </div>
        </div>
        <div class="row row-grid mt-5">
          <div class="col-lg-4">
            ...
            <h5 class="text-white mt-3">Aman</h5>
            <p class="text-white mt-3">Sudah terdaftar di Otoritas Jasa Keuangan</p>
          </div>
          <div class="col-lg-4">
            <div class="icon icon-lg icon-shape bg-gradient-white shadow rounded-circle text-primary">
              <i class="ni ni-ruler-pencil text-primary"></i>
            </div>
            <h5 class="text-white mt-3">Tepat</h5>
            <p class="text-white mt-3">Pembiayaan kami menyasar ke mahasiswa yang kekurangan pembiayaan</p>
          </div>
          <div class="col-lg-4">
            <div class="icon icon-lg icon-shape bg-gradient-white shadow rounded-circle text-primary">
              <i class="ni ni-atom text-primary"></i>
            </div>
            <h5 class="text-white mt-3">Terpercaya</h5>
            <p class="text-white mt-3">Sudah di pakai lebih dari 10.000 pengguna</p>
          </div>
        </div>
      </div>
      <!-- SVG separator -->
          ...
          <div class="col-lg-8">
            <div class="card bg-gradient-secondary shadow">
              <div class="card-body p-lg-5">
                <h4 class="mb-1">Tanyakan Kepada Kami</h4>
                ...
                <div class="form-group mb-4">
                  <textarea class="form-control form-control-alternative" name="name" rows="4" cols="80" placeholder="pertanyyan..."></textarea>
                </div>
                <div>
                  <button type="button" class="btn btn-default btn-round btn-block btn-lg">Kirim Pertanyaan </button>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row row-grid justify-content-center">
          <div class="col-lg-8 text-center">
            <h2 class="display-3"><span class="text-success">Apakah tersedia Versi Mobile ?</span></h2>
            <p class="lead">Layanan kami juga tersedia dalam platform mobile, yang pastinya dapat memudahkan pengguna dalam melakukan transaksi</p>
            <div class="btn-wrapper">
              <a href="https://www.creative-tim.com/product/argon-design-system" class="btn btn-primary mb-3 mb-sm-0">Google Play</a>
              <a href="https://www.creative-tim.com/product/argon-design-system" class="btn btn-default">App Strore</a>
            </div>
  ...
  <footer class="footer has-cards">
        ...
        <div class="col-md-6 mb-5 mb-md-0">
          <div class="card card-lift--hover shadow border-0">
            <a href="../examples/landing.html" title="Landing Page">
              <img alt="image" src="./assets/img/theme/splash.jpg" class="card-img">
            </a>
          </div>
        </div>
        <div class="col-md-6 mb-5 mb-lg-0">
          <div class="card card-lift--hover shadow border-0">
            <a href="../examples/profile.html" title="Profile Page">
              <img alt="image" src="./assets/img/theme/home.jpg" class="card-img">
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row row-grid align-items-center my-md">
        <div class="col-lg-6">
          <h3 class="text-primary font-weight-light mb-2">Terima Kasih Atas Dukungannya</h3>
          <h4 class="mb-0 font-weight-light">Silahkan Kunjungi Sosial Media Kami</h4>
        </div>
      ...
      <div class="row align-items-center justify-content-md-between">
        <div class="col-md-6">
          <div class="copyright">
            &copy; 2019 <a href="https://www.creative-tim.com" target="_blank">FinePay</a>.
          </div>
        </div>
        <div class="col-md-6">
          <ul class="nav nav-footer justify-content-end">
            <li class="nav-item">
              <a href="https://www.creative-tim.com" class="nav-link" target="_blank">FinePay</a>
            </li>
            <li class="nav-item">
