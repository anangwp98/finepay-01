  ...
  <?php
		...
		$hasil_query_report_topup = mysqli_query($koneksi, $query_report_topup); 
			...
			?>
   	        <tbody>
   	          <tr>
   	            <td ><?php echo $row_r_topup['id_topup']; ?></td>
   	            <td ><?php echo $row_r_topup['nama']; ?></td>
                <td align="center"><?php echo $row_r_topup['tanggal_topup']; ?></td>
                <td align="center"><?php echo $row_r_topup['keterangan_topup']; ?></td>
                <td align="center"><?php echo $row_r_topup['jumlah_topup']; ?></td>                
                <td align="center"><?php echo $row_r_topup['saldo_awal']; ?></td>
   	            <td align="center"><?php echo $row_r_topup['saldo_akhir']; ?></td>
   	            <td align="center"><?php echo $row_r_topup['tgl_diterima']; ?></td>
